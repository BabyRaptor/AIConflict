function MediumPanel(layer, style, x, y, w, h) {
	var PANEL_UNIT_SIZE = 50;
	var instance = this;
	...
	for (var i=0; i<w; i++) {
		...
		for (var j=0; j<h; j++) {
			if (i==0 && j==0) {
				this.m_sprites[i][j] = new cc.Sprite("res/UI/MediumPanel/Corner-" + style + ".png");
				...
				this.m_sprites[i][j] = new cc.Sprite("res/UI/MediumPanel/Edge-" + style + ".png");
				this.m_sprites[i][j].setRotation (0);
			}
			else if (i==w-1) {
				this.m_sprites[i][j] = new cc.Sprite("res/UI/MediumPanel/Edge-" + style + ".png");
				...
				this.m_sprites[i][j] = new cc.Sprite("res/UI/MediumPanel/Mid-" + style + ".png");
				this.m_sprites[i][j].setRotation (0);
			}
