...
function EnemyCommon(battle, layer, area, type, path, modifier) {
	
}

function CreateEnemyPrototype(battle, layer, area, type, path, modifier) {
	var enemy = new EnemyCommon(battle, layer, area, type, path, modifier);
	return enemy;
}
