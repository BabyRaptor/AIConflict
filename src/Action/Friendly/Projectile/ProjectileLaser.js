...
function ProjectileLaser(battle, layer, owner) {
	...
	this.m_sprite = g_spritePool.GetSpriteFromPool("res/GSAction/Turret/4-Laser/Laser.png");
	...
	this.m_tipSprite1 = g_spritePool.GetSpriteFromPool("res/GSAction/Turret/4-Laser/LaserTip.png");
	...
	this.m_tipSprite2 = g_spritePool.GetSpriteFromPool("res/GSAction/Turret/4-Laser/LaserTip.png");
