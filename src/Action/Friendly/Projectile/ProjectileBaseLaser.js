...
function ProjectileBaseLaser(battle, layer, owner) {
	...
	this.m_sprite = g_spritePool.GetSpriteFromPool("res/GSAction/Base/Laser.png");
	...
	this.m_tipSprite1 = g_spritePool.GetSpriteFromPool("res/GSAction/Base/LaserTip.png");
	...
	this.m_tipSprite2 = g_spritePool.GetSpriteFromPool("res/GSAction/Base/LaserTip.png");
