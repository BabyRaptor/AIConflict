...
function TurretGatling (battle, layer, x, y) {
	...
	this.m_baseSprite = GetFromPool("res/GSAction/Turret/1-Gatling/Base.png");
	...
	this.m_shadowSprite = GetFromPool("res/GSAction/Turret/1-Gatling/Shadow.png");
	...
	this.m_turretSprite = GetFromPool("res/GSAction/Turret/1-Gatling/Turret.png");
	...
	this.Shoot = function() {
		if (cooldownCount <= 0) {
			...
			battle.SpawnProjectile (PROJECTILE_GATLING, this.m_x, this.m_y, angle, this.m_level);
