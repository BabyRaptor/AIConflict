...
function TurretLaser (battle, layer, x, y) {
	...
	this.m_baseSprite = GetFromPool("res/GSAction/Turret/4-Laser/Base.png");
	...
	this.m_shadowSprite = GetFromPool("res/GSAction/Turret/4-Laser/Shadow.png");
	...
	this.m_turretSprite = GetFromPool("res/GSAction/Turret/4-Laser/Turret.png");
