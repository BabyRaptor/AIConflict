...
var TURRET_GAUSS = 5;
var TURRET_GAUSS_PRICE = [400, 200, 250, 300, 350];
...
function TurretGauss (battle, layer, x, y) {
	...
	this.m_baseSprite = GetFromPool("res/GSAction/Turret/5-Gauss/Base.png");
	...
	this.m_shadowSprite = GetFromPool("res/GSAction/Turret/5-Gauss/Shadow.png");
	...
	this.m_turretSprite = GetFromPool("res/GSAction/Turret/5-Gauss/Turret.png");
	...
	this.Shoot = function() {
		if (cooldownCount <= 0) {
			...
			battle.SpawnProjectile (PROJECTILE_GAUSS, this.m_x, this.m_y, angle, this.m_level);
