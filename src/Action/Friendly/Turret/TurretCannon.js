...
function TurretCannon (battle, layer, x, y) {
	...
	this.m_baseSprite = GetFromPool("res/GSAction/Turret/2-Cannon/Base.png");
	...
	this.m_shadowSprite = GetFromPool("res/GSAction/Turret/2-Cannon/Shadow.png");
	...
	this.Shoot = function() {
		if (cooldownCount <= 0) {
			...
			battle.SpawnProjectile (PROJECTILE_CANNON, this.m_x, this.m_y, angle, this.m_level);
