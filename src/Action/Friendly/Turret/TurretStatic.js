...
function TurretStatic (battle, layer, x, y) {
	...
	this.m_baseSprite = g_spritePool.GetSpriteFromPool("res/GSAction/Turret/6-Static/Base.png");
	...
	this.m_shadowSprite = g_spritePool.GetSpriteFromPool("res/GSAction/Turret/6-Static/Shadow.png");
	...
	this.m_turretSprite = g_spritePool.GetSpriteFromPool("res/GSAction/Turret/6-Static/Turret.png");
