...
// At wave 1, spawn enemy at gate 0, at moment 1 sec (don't use 0), enemy area 1, 
// enemy type 1, 10 of them, 1 sec latency each, modifier 1 => normal HP
//tempMission.AddWaveData (1, new WaveData(0, 1, 1, 4, 1, 5, 1));
